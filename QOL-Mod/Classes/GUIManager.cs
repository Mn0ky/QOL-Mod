...
namespace QOL
{
    public class GUIManager : MonoBehaviour
    {
        ...
        public void OnGUI()
        {
            ...
            this.MenuRect = GUILayout.Window(this.WindowId, this.MenuRect, new GUI.WindowFunction(this.KickWindow), "<color=red><b><i>Monk's QOL Menu</i></b></color>\t[v1.0.5]", new GUILayoutOption[0]);
        }
